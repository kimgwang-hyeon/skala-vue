...
<template>
  <div class="container">
    <h1>Vue3 Composition API 실습 노트</h1>

    <!-- 섹션 1 -->
    <section class="card">
      <h2>1. 반응형 상태 ref() 기초</h2>
      <p>ref()를 활용한 단일 값 및 객체/배열 반응형 상태 관리 예제입니다.</p>
      <ReactiveRef />
    </section>
